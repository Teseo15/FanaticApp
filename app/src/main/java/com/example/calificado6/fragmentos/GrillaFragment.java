...
public class GrillaFragment extends Fragment {
    ...
    public GrillaFragment() { }
    public static GrillaFragment newInstance(String param1, String param2) {
        GrillaFragment fragment = new GrillaFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rcvPeliculas.setLayoutManager(new GridLayoutManager(getContext(),2));

        obtenerDataPeliculas();
        PeliculaAdapter adapter=new PeliculaAdapter(dataPeliculas);
        rcvPeliculas.setAdapter(adapter);
        return view;
    }
    private void obtenerDataPeliculas() {
